...
class CustomerSupplierCreatePage extends StatelessWidget {
  CustomerSupplierCreatePage({super.key});
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Get.find<CustomerSupplierController>().loadCustomerData();
    });
                  ...
                  children: [
                    ...
                    RadioListTile<int>(
                      ...
                      onChanged: (int? newValue) {
                        print("onChanged called1: $newValue");
                        controller.userType = newValue!;
                        print("onChanged called2: ${controller.userType}");
                        controller.update();
                      },
                    ...
                    RadioListTile<int>(
                      ...
                      groupValue: controller.userType,
                      onChanged: (int? newValue) {
                        print("onChanged called3: ${newValue}");
                        controller.userType = newValue!;
                        print("onChanged called4: ${controller.userType}");
                        controller.update();
                      },
                                ...
                                Expanded(
                                  child: ElevatedButton(
                                    onPressed: () =>
                                      ...
                                      controller.selectedImageFilepPath =
                                          imagePath;
                                      controller.update();
                                    }),
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton(
                            ...
                            child:
                                Text(controller.isUpdate ? 'Update' : 'Submit'),
                          ),
                        ),
                      ],
                    ),
